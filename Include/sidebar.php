    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-group">
            ...
            <ul class="nav-group-items">
                <li class="nav-item"><a class="nav-link" href="../Tenants/list.php"><span class="nav-icon"></span> Tenants List</a></li>
                <li class="nav-item"><a class="nav-link" href="../Tenants/add.php"><span class="nav-icon"></span> Add Tenant</a></li>
            </ul>
        </li>
